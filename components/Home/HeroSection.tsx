  ...
  <section id="accueil" className="relative h-[600px] overflow-hidden">
    ...
    <div className="container mx-auto px-4 h-full flex items-center relative z-20">
      <div className="max-w-2xl text-white">
        <h1 className="text-5xl md:text-6xl font-serif font-bold mb-4">Institut Universitaire Jean-Paul II</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Button className="bg-[#D4AF37] hover:bg-[#D4AF37]/80 text-white px-8 py-6 text-lg !rounded-button whitespace-nowrap">
            Découvrir nos formations
            <i className="fas fa-arrow-right ml-2"></i>
          </Button>
          <Button variant="outline" className="text-white hover:text-white bg-[#1B2A4A]/50 hover:bg-[#1B2A4A]/30 px-8 py-6 text-lg !rounded-button whitespace-nowrap">
            Visite virtuelle
